  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900">
      <div className="text-center text-white">
        <div className="text-2xl font-bold text-brand mb-6">BuildOne</div>
        ...
        <Link
          ...
          className="inline-block bg-brand text-white font-semibold rounded-xl px-6 py-3 hover:bg-brand-dark transition-colors"
        >
          Sign out &amp; try again
        </Link>
      </div>
